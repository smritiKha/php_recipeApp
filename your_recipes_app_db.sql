...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2023 at 06:03 AM
...
INSERT INTO `tbl_ads` (`id`, `ad_status`, `ad_type`, `backup_ads`, `admob_publisher_id`, `admob_app_id`, `admob_banner_unit_id`, `admob_interstitial_unit_id`, `admob_native_unit_id`, `admob_app_open_ad_unit_id`, `fan_banner_unit_id`, `fan_interstitial_unit_id`, `fan_native_unit_id`, `startapp_app_id`, `unity_game_id`, `unity_banner_placement_id`, `unity_interstitial_placement_id`, `applovin_banner_ad_unit_id`, `applovin_interstitial_ad_unit_id`, `applovin_native_ad_manual_unit_id`, `applovin_app_open_ad_unit_id`, `applovin_banner_mrec_zone_id`, `applovin_banner_zone_id`, `applovin_interstitial_zone_id`, `ad_manager_banner_unit_id`, `ad_manager_interstitial_unit_id`, `ad_manager_native_unit_id`, `ad_manager_app_open_ad_unit_id`, `ironsource_app_key`, `ironsource_banner_placement_name`, `ironsource_interstitial_placement_name`, `wortise_app_id`, `wortise_banner_unit_id`, `wortise_interstitial_unit_id`, `wortise_native_unit_id`, `wortise_app_open_unit_id`, `mopub_banner_ad_unit_id`, `mopub_interstitial_ad_unit_id`, `interstitial_ad_interval`, `native_ad_interval`, `native_ad_index`, `date_time`) VALUES
(1, 'on', 'admob', 'none', 'pub-3940256099942544', 'ca-app-pub-3940256099942544~3347511713', 'ca-app-pub-3940256099942544/6300978111', 'ca-app-pub-3940256099942544/1033173712', 'ca-app-pub-3940256099942544/2247696110', 'ca-app-pub-3940256099942544/3419835294', 'IMG_16_9_APP_INSTALL#1102290040176998_1102321626840506', 'IMG_16_9_APP_INSTALL#1102290040176998_1103218190084183', 'IMG_16_9_APP_INSTALL#1102290040176998_1142394442833224', '0', '4089993', 'banner', 'video', '0', '0', '0', '0', '0', '0', '0', '/6499/example/banner', '/6499/example/interstitial', '/6499/example/native', '/6499/example/app-open', '85460dcd', 'DefaultBanner', 'DefaultInterstitial', 'test-app-id', 'test-banner', 'test-interstitial', 'test-native', 'test-app-open', 'b195f8dd8ded45fe847ad89ed1d016da', '24534e1901884e398f1253216226017e', 3, 10, 6, '2023-06-22 06:35:38');
...
CREATE TABLE `tbl_ads_placement` (
  ...
  `native_ad_home` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `tbl_ads_placement` (`ads_placement_id`, `banner_home`, `banner_post_details`, `banner_category_details`, `banner_search`, `interstitial_post_list`, `interstitial_post_details`, `native_ad_home`, `native_ad_post_list`, `native_ad_post_details`, `native_ad_exit_dialog`, `app_open_ad_on_start`, `app_open_ad_on_resume`) VALUES
...
CREATE TABLE `tbl_app_config` (
  ...
  `redirect_url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Your Recipes App', 'Hello World, This is Your Recipes App, you can purchase it on Codecanyon officially.', '9450-2020-05-06.jpg', 'https://codecanyon.net/item/your-recipes-app/13041482');
...
(1, 20, '1588779046_broiledlobster.jpg'),
(2, 6, '1588779307_nasilemak1.jpg'),
(3, 6, '1588779307_nasilemak2.jpg'),
(4, 24, '1588779773_nasgor2.jpg'),
(5, 24, '1588779773_nasgor1.jpg');
