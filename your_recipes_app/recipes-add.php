...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $_SESSION['msg'] = "Recipes added successfully...";
...
<script type="text/javascript">
   ...
   <section class="content">
        ...
        <ol class="breadcrumb breadcrumb-offset">
            ...
            <li class="active">Add Recipes</a></li>
        </ol>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="recipe_title" id="recipe_title" placeholder="News Title" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="recipe_time" id="recipe_time" class="form-control" placeholder="Recipe Time" required>
                                        </div>
                                    </div>
                                    ...
                                    <div id="video_post">
                                        ...
                                        <div class="form-group">
                                            <input type="file" name="post_image" id="post_image" class="dropify-image" data-max-file-size="8M" data-allowed-file-extensions="jpg jpeg png gif" required />
                                        </div>
                                    ...
                                    <div id="direct_url">
                                        <div class="form-group">
                                            <input type="file" name="image" id="image" class="dropify-image" data-max-file-size="8M" data-allowed-file-extensions="jpg jpeg png gif" />
                                        </div>
                                        <div class="form-group">
                                            <div class="font-12">Video URL</div>
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="url_source" id="url_source" placeholder="http://www.xyz.com/recipe_title.mp4" required/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="video_upload">
                                        <div class="form-group">
                                            <input type="file" id="recipe_image" name="recipe_image" id="recipe_image" class="dropify-image" data-max-file-size="8M" data-allowed-file-extensions="jpg jpeg png gif" required />
                                        </div>
